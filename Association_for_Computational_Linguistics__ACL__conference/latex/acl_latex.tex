...
\author{
  ...
  Chicago, IL, USA \\
  \texttt{\{njulu, hamsini\_placeholder, ganesh\_placeholder\}@uic.edu}
}
...
TrustLayer verifies generated answers using multiple signals. Evidence similarity is computed between the generated answer and retrieved chunks using normalized sentence embeddings. Evidence coverage measures lexical overlap between answer words and retrieved context words. NLI verification uses \texttt{MoritzLaurer/deberta-v3-base-mnli-fever-anli} to estimate entailment and contradiction between evidence and answer.
